...
export default function Opensource({title, company, url}: {title: string, company: string, url: string}){
    return (
    <div className="flex justify-between items-start text-neutral-400 px-4 py-4 rounded-lg bg-bg-color-gray sm:items-start">
        ...
        <div>
        <h1 className=" text-white text-sm hover:underline"><a href={url}>{title}</a></h1>
